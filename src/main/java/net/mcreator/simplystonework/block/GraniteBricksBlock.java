...
public class GraniteBricksBlock extends Simplystonework7513ModElements.ModElement {
	@ObjectHolder("simplystonework7513:granite_bricks")
	public static final Block block = null;
	public GraniteBricksBlock(Simplystonework7513ModElements instance) {
		super(instance, 147);
	}
