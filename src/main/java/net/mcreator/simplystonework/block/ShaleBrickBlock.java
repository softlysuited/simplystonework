...
public class ShaleBrickBlock extends Simplystonework7513ModElements.ModElement {
	@ObjectHolder("simplystonework7513:shale_brick")
	public static final Block block = null;
	public ShaleBrickBlock(Simplystonework7513ModElements instance) {
		super(instance, 40);
	}
