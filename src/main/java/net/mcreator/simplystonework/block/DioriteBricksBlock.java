...
public class DioriteBricksBlock extends Simplystonework7513ModElements.ModElement {
	@ObjectHolder("simplystonework7513:diorite_bricks")
	public static final Block block = null;
	public DioriteBricksBlock(Simplystonework7513ModElements instance) {
		super(instance, 142);
	}
