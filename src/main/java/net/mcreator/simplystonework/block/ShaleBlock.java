...
public class ShaleBlock extends Simplystonework7513ModElements.ModElement {
	@ObjectHolder("simplystonework7513:shale")
	public static final Block block = null;
	public ShaleBlock(Simplystonework7513ModElements instance) {
		super(instance, 38);
