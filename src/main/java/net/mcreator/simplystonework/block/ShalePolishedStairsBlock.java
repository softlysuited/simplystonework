...
public class ShalePolishedStairsBlock extends Simplystonework7513ModElements.ModElement {
	@ObjectHolder("simplystonework7513:shale_polished_stairs")
	public static final Block block = null;
	public ShalePolishedStairsBlock(Simplystonework7513ModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("shale_polished_stairs");
		}
