...
public class AndesiteBrickStairsBlock extends Simplystonework7513ModElements.ModElement {
	@ObjectHolder("simplystonework7513:andesite_brick_stairs")
	public static final Block block = null;
	public AndesiteBrickStairsBlock(Simplystonework7513ModElements instance) {
		super(instance, 154);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(1.6f, 10f)).getDefaultState(),
