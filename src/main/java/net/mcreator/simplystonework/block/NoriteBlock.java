...
public class NoriteBlock extends Simplystonework7513ModElements.ModElement {
	@ObjectHolder("simplystonework7513:norite")
	public static final Block block = null;
	public NoriteBlock(Simplystonework7513ModElements instance) {
		super(instance, 13);
