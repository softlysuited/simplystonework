...
public class PegmatiteBlock extends Simplystonework7513ModElements.ModElement {
	@ObjectHolder("simplystonework7513:pegmatite")
	public static final Block block = null;
	public PegmatiteBlock(Simplystonework7513ModElements instance) {
		super(instance, 26);
